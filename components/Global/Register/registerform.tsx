...
>>>>>>> Stashed changes
        ...
        <button
          type="button"
          disabled={isDisabled}
          className="w-full flex items-center justify-center px-6 py-2 border border-gray-300 rounded-sm hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors duration-200"
        >
